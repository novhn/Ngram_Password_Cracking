python ngram_freq_analyzer.py 1 ./password_lists/top_10000_pwd.txt ./markov_models/hmm_top10000_uni_exist.txt existing
...
python ngram_freq_analyzer.py 1 ./password_lists/top_10000_pwd.txt ./markov_models/hmm_top10000_uni_all.txt all
